...
(function() {
  (this.myTerminal = function() {
    ...
    help = "Docker tutorial \n \n The Docker tutorial is a Docker emulater intended to help novice users get up to spead with the standard Docker commands. This terminal contains a limited Docker and a limited shell emulator. Therefore some of the commands you would expect do not exist.\n \n Just follow the steps and questions. If you are stuck, click on the 'Show the answer' to see what the command should have been. Leave feedback if you find things confusing.";
